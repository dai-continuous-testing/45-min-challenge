...
public class AndroidLoginTest extends BaseTest {
	...
	public void test(){
		...
		driver.findElement(in.Repo.obj("and_login.passwordTextField")).sendKeys("company");
		driver.findElement(in.Repo.obj("and_login.loginButton")).click();
		driver.findElement(in.Repo.obj("and_main.makePaymentButton"));
		driver.findElement(in.Repo.obj("and_main.logoutButton")).click();
	}
